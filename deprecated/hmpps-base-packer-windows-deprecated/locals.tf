...
locals {
  ...
  # CodeBuild - General
  #======================
  common_name    = "hmpps-base-packer-builder-windows"
  build_timeout  = "120"
  queued_timeout = "30"
  ...
  stream_name = "hmpps-base-packer-ami-windows-bake"
  ...
  build_source = {
    ...
    buildspec = "buildspec_windows.yml"
  }
  ...
  project_names = {
    ami_build       = "hmpps-base-packer-ami-windows-build"
  }
