...
resource "github_repository_webhook" "github_repository_webhook_hmpps_base_packer_windows_prbranch" {
  repository = data.github_repository.hmpps_base_packer.name

  configuration {
    url          = aws_codepipeline_webhook.codepipeline_webhooks_hmpps_base_packer_windows_prbranch.url
    content_type = "json"
    insecure_ssl = false
...
resource "aws_codepipeline_webhook" "codepipeline_webhooks_hmpps_base_packer_windows_prbranch" {
  name            = "github-webhooks-hmpps-base-packer-windows-prbranch"
